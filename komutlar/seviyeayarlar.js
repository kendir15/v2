...
let kanal1 = [];
  if(kanal) kanal1 = `<a:monn:722716496584769546> **Açık!**`
  if(!kanal) kanal1 = `<a:monn:722716496584769546> **Kapalı!**`

  let xp1 = [];
  if(xp) xp1 = `<a:monn:722716496584769546> \`${xp}\``
  if(!xp) xp1 = `<a:monn:722716496584769546> **Ayarlanmamış! Default: \`250\`**`

let sınır1 = [];
  if(sınır) sınır1 = `<a:monn:722716496584769546> \`${sınır}\``
  if(!sınır) sınır1 = `<a:monn:722716496584769546> **Ayarlanmamış! Default: \`5\`**`
